---
title: "The 27 Nakshatras: Your Lunar Mansion Guide"
description: "Discover the 27 Nakshatras in Vedic astrology—lunar mansions that reveal deep personality traits, karma, and life purpose beyond your zodiac sign."
date: "2026-02-12"
author: "North Star Astro"
tags: ["nakshatras", "vedic astrology", "jyotish", "lunar mansions", "moon sign", "birth star"]
faq:
  - question: "What are Nakshatras in Vedic astrology?"
    answer: "Nakshatras are 27 lunar mansions or star divisions in Vedic astrology, each spanning 13°20' of the zodiac. Your birth Nakshatra is where the Moon was positioned at your birth, revealing deep psychological patterns, karmic themes, and life purpose."
  - question: "How do I find my Nakshatra?"
    answer: "Calculate your Vedic birth chart using your exact birth date, time, and location. The Nakshatra is determined by your Moon's degree position. Vedic astrology calculators will automatically identify your Nakshatra and its characteristics."
  - question: "Are Nakshatras the same as zodiac signs?"
    answer: "No, Nakshatras are more specific. While there are 12 zodiac signs of 30° each, there are 27 Nakshatras of 13°20' each. Each zodiac sign contains 2-3 Nakshatras, providing much finer detail than sign placement alone."
  - question: "What is a Nakshatra's ruling deity?"
    answer: "Each Nakshatra has an associated Hindu deity that represents its archetypal energy and mythology. For example, Ashwini is ruled by the Ashwini Kumaras (divine physicians), influencing healing and swift action themes for those born under it."
  - question: "Why are Nakshatras important in Vedic astrology?"
    answer: "Nakshatras reveal personality layers beyond your zodiac sign, determine your Vimshottari Dasha starting period, indicate compatibility in relationships, and are used for muhurta (electional astrology) to select auspicious timing for events."
---
...
This makes the Nakshatra absolutely central to predictive astrology. To learn more about how the dasha system works, read our guide on [Vedic Dasha systems](/blog/dasha-system-explained).
...
1. **Calculate your Vedic birth chart** using an accurate Vedic astrology calculator (you'll need exact birth date, time, and location)

2. **Locate your Moon's position** in degrees (e.g., "Moon at 18°30' Scorpio")

3. **Identify the Nakshatra**: Each 13°20' segment corresponds to one Nakshatra. At 18°30' Scorpio, you'd be in Jyeshtha Nakshatra (which runs from 16°40' to 30°00' Scorpio)

4. **Note the pada (quarter)**: Each Nakshatra is divided into four padas of 3°20' each, corresponding to the four Navamsha divisions. Your pada adds another layer of interpretation

5. **Read about your Nakshatra's qualities**: Explore the mythology, deity, ruling planet, and themes associated with your birth star
...
To understand the complete context of Vedic astrology and how Nakshatras fit into the larger system, explore our [introduction to Vedic astrology](/blog/what-is-vedic-astrology). And to see how Vedic astrology's approach differs from Western astrology, read our comparison article on [Vedic vs Western astrology](/blog/vedic-vs-western-astrology).
